...
from sistema_bancario.sistema import (
    Cliente,
    Conta,
    ContaIterador,
    PessoaFisica,
...
def _interface_adicionar_cliente(adicionar_cliente):
    ...
    cliente = PessoaFisica(cpf=cpf, data_nascimento=data_nascimento, endereco=endereco, nome=nome)
    resultado = adicionar_cliente(cliente)
